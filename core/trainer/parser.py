...
def set_parser_train(parser):
    ...
    parser.add_argument('--num-batches', default=None, help='Batch number.')
    ...
    parser.add_argument('--data', type=str, default='cifar10', choices=DATASETS, help='Data to use.')
    ...
    parser.add_argument('--model', default='wrn-28-10-swish', help='Model architecture to be used.')
